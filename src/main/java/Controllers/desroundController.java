...
public class desroundController {
    ...
    @FXML
    private Label leftOutputLabel;
    @FXML
    private Label rightOutputLabel;
    ...
    protected void computeDESRound() {
        ...
        try {
            ...
            leftOutputLabel.setText(newLeftStr);
            rightOutputLabel.setText(newRightStr);
        } catch (NumberFormatException e) {
            // handle invalid vyne pune
            leftOutputLabel.setText("Invalid input");
            rightOutputLabel.setText("Invalid input");
        }
    }
